...
وقتی نیاز طبیعی به فعالیت ذهنی و فوریجینگ برآورده نشود، طوطی معمولاً یکی از چند مسیر را می‌رود — از جمله جیغ‌کشیدن بیش‌ازحد که خودش یکی از شایع‌ترین علائم کسالت مزمن است؛ چرایی این ارتباط و راه افتراقش از سایر علل را در [جیغ‌کشیدن بیش‌ازحد در طوطی‌ها](/articles/excessive-screaming-parrots/) بخوانید:
...
جابه‌جایی گاه‌به‌گاه جاپایی‌ها، ارتفاع‌های مختلف برای نشستن، و دسترسی (تحت نظارت) به فضای خارج از قفس، حس کاوش را زنده نگه می‌دارد. اگر پرنده‌تان بال کوتاه‌شده دارد، این تحرک آزاد اهمیت بیشتری پیدا می‌کند تا کاهش پرواز به کاهش کلی فعالیت تبدیل نشود؛ بحث کامل مزایا و ریسک‌های کوتاه‌کردن بال را در [کوتاه‌کردن بال طوطی](/articles/wing-clipping-pet-birds/) بخوانید.
