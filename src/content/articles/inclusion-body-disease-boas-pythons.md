...
- **کنه‌ی مار (Snake Mite)** یکی از راه‌های انتقال شناخته‌شده است؛ همین کنه‌های ریز که در [انگل‌های داخلی و خارجی خزندگان](/articles/internal-parasites-in-reptiles/) هم به‌عنوان یک تهدید جدی معرفی شده‌اند، می‌توانند ویروس را از مار آلوده به مار سالم منتقل کنند.
