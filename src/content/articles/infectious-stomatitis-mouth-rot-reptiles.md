...
4. **مرحله‌ی جدی (استئومیلیت)**: عفونت به استخوان فک گسترش پیدا می‌کند — در این مرحله درمان بسیار طولانی‌تر و پیچیده‌تر است و احتمال آسیب دائمی به ساختار فک وجود دارد. در موارد شدید، عفونت می‌تواند سیستمیک شده و کل بدن را درگیر کند؛ گاهی هم به‌جای گسترش سیستمیک، عفونت موضعی در بافت اطراف فک محصور شده و به یک [آبسه](/articles/abscesses-in-reptiles/) تبدیل می‌شود — توده‌ای سفت که برخلاف آبسه‌ی سگ و گربه، فقط با جراحی کامل قابل رفع است.
