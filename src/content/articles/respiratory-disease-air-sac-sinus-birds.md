...
- **دستگاه تنفسی تحتانی (ریه و کیسه‌های هوایی):** درگیری عمیق‌تر و معمولاً خطرناک‌تر، شامل التهاب کیسه‌ی هوایی (air sacculitis) که می‌تواند باکتریایی، قارچی یا حتی ناشی از جسم خارجی باشد. در قناری و فنچ، یک علت انگلی مشخص و نسبتاً شایع هم وجود دارد که سازوکار کاملاً متفاوتی دارد؛ جزئیات آن را در [کنه‌ی کیسه‌ی هوایی در قناری و فنچ](/articles/air-sac-mites-canaries-finches/) بخوانید.
