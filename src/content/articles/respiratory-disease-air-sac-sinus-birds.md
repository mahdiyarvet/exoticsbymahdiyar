...
- **هرگز از اسپری‌های خوشبوکننده، دود سیگار، شمع معطر یا تفلون/روکش نچسب داغ‌شده در نزدیکی پرنده استفاده نکنید** — بخارات تفلون داغ‌شده می‌توانند در عرض دقایق برای پرنده کشنده باشند؛ این یکی از خطرناک‌ترین و کمترشناخته‌شده‌ترین ریسک‌های خانگی برای پرندگان است.
